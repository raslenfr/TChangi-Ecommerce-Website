...
<?php
        ...
        ?><i class="fa-solid fa-thumbs-up"> </i>
				...
				<div class="like" id="like">	
					<form method="POST" action="likedes.php" class="Like">
						<div class="icon-like"><i class="fa-solid fa-thumbs-up"> </i> <?= $pub['likee']; ?></div>
						<input type="submit" name="like" value="" class="like-btn">
                       
                 	</form>
				</div>

				<div class="deslike"><a href=""><i class="fa-solid fa-thumbs-down"><?= $pub['deslikee']; ?></i></a></div>
				<div class="pub-1">
