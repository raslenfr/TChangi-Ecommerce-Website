			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li><a href="http://localhost/proj3/jasserr/View/test.php">Facture </a></li>
					</ul>
					<!-- /NAV -->
				</div>
				<!-- /responsive-nav -->
...
<center>
        ...
        <a href="testadd.php" class="Btn_add"> <img src="images/plus.png"> Add livraison</a>
    ...
    <table >
        ...
        ?>
            <tr>
                ...
                <td >
                    <form method="POST" action="updatelivr.php">
                      <a href="updatelivr.php"> <img src="images/pen.png"></a>    
                        <input type="hidden" value="<?PHP echo $livr['id_livraison']; ?>" name="id_livraison">
                        <input type="submit" >
                    </form>
                </td>
                <td>
                    <a href="deletelivr.php?id_livraison=<?php echo $livr['id_livraison']; ?>"> <img src="images/trash.png" ></a>
                </td>
            </tr>
        <?php
        }
