...
<center>
        ...
        <a href="testadd.php" class="Btn_add"> <img src="images/plus.png"> Add Facture</a>
            ...
            <tr>
                ...
                <td >
                    <form method="POST" action="updatefacture.php">
                      <a href="updatefacture.php"> <img src="images/pen.png"></a>    
                        <input type="hidden" value="<?PHP echo $facture['id_facture']; ?>" name="id_facture">
                        <input type="submit">
                    </form>
                </td>
                <td>
                    <a href="deletefacture.php?id_facture=<?php echo $facture['id_facture']; ?>"> <img src="images/trash.png" ></a>
                </td>
            </tr>
        <?php
        }
